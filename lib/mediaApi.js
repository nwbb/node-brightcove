...
api.prototype.makeRequest = function makeRequest(command, options, callback) {
	...
	if(command === "create_video") {
		...
		// Don't want this on the json data attr anymore as we have it in 'fileToAdd'
	...
	if(fileToAdd) form.append('file', fileToAdd, {	contentType: 'application/octet-stream' });
