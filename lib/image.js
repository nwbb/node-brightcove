...
image.ConvertJsonToImage = function ConvertJsonToImage(json) {
	...
	if (json.type) imageInstance.type = json.type;
...
image.prototype.isThumbnail = function setAsThumbnail() {
	this.type = 'THUMBNAIL';
	return this;
}

image.prototype.isVideoStill = function setAsVideoStill() {
	this.type = 'VIDEO_STILL';
	return this;
}
...
image.prototype.checksum = function setChecksum(value) {
	this.checksum = value;
	return this;
}
